            ...
            <div class="h-full flex flex-col">
                ...
                <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
                    <a href="{{ route('admin.dashboard') }}" 
                       class="sidebar-nav-item nav-link flex items-center space-x-3 px-4 py-3 rounded-lg relative transition-all duration-300 {{ request()->routeIs('admin.dashboard') ? 'bg-cyan-500 text-white active' : 'text-gray-300' }}">
                    ...
                    <a href="{{ route('admin.reports.index') }}" 
                       class="sidebar-nav-item nav-link flex items-center space-x-3 px-4 py-3 rounded-lg relative transition-all duration-300 {{ request()->routeIs('admin.reports.*') ? 'bg-cyan-500 text-white active' : 'text-gray-300' }}">
                        <svg class="w-5 h-5 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('admin.students.index') }}" 
                       class="sidebar-nav-item nav-link flex items-center space-x-3 px-4 py-3 rounded-lg relative transition-all duration-300 {{ request()->routeIs('admin.students.*') ? 'bg-cyan-500 text-white active' : 'text-gray-300' }}">
                        <svg class="w-5 h-5 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('admin.categories.index') }}" 
                       class="sidebar-nav-item nav-link flex items-center space-x-3 px-4 py-3 rounded-lg relative transition-all duration-300 {{ request()->routeIs('admin.categories.*') ? 'bg-cyan-500 text-white active' : 'text-gray-300' }}">
                        <svg class="w-5 h-5 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('admin.buildings.index') }}" 
                       class="sidebar-nav-item nav-link flex items-center space-x-3 px-4 py-3 rounded-lg relative transition-all duration-300 {{ request()->routeIs('admin.buildings.*') ? 'bg-cyan-500 text-white active' : 'text-gray-300' }}">
                        <svg class="w-5 h-5 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('admin.analytics.index') }}" 
                       class="sidebar-nav-item nav-link flex items-center space-x-3 px-4 py-3 rounded-lg relative transition-all duration-300 text-gray-300">
                        <svg class="w-5 h-5 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
