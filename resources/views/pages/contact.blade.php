...
<div class="max-w-4xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <a href="mailto:support@lapormahasiswa.ac.id" class="text-navy-800 hover:text-navy-700 font-medium">
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <a href="tel:+62-XXX-XXXX-XXXX" class="text-navy-800 hover:text-navy-700 font-medium">
                +62-XXX-XXXX-XXXX
            </a>
        </div>
    ...
    <div class="mt-12 bg-gray-50 rounded-lg p-8">
        ...
        <p class="text-gray-600 mb-6">
            ...
            <a href="{{ route('faq') }}" class="text-navy-800 hover:text-navy-700 font-medium">Kunjungi halaman FAQ kami</a>
        </p>
    </div>
</div>
@endsection
